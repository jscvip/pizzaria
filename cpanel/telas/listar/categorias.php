<?php
$pagina = "index.php?p=listar_categorias";
$tabela = "categorias";
...
<div class="panel panel-info">
    <div class="panel-heading text-center">:.LISTANDO CATEGORIAS.:</div>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; padding: 2px;">
                            ...
                            <?php if (excluir($tabela)) {
                                dlConfirma($pagina . "&acao=deletar&id=" . $d["id"], "Deletar categoria", "Tem certeza que quer deletar essa Categoria? Ao Deletar essa categoria as pizzas vinculadas a ela também serão excluidas!", "glyphicon-trash");
                            } ?>
                        </td>
                    </tr>
                <?php } ?>
