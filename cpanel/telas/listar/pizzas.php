...
$pagina = "index.php?p=listar_pizzas";
$tabela = "pizzas";
...
<div class="panel panel-info">
    <div class="panel-heading text-center">:.LISTANDO PIZZAS.:</div>
            ...
            foreach ($page_data as $d) { ?>
                    <tr>
                        <td style="padding: 2px; vertical-align: middle;">
                            <img src="../images/fotos/<?php echo $d["img_inicio"]; ?>" height="50">
                        </td>
                        <td style="padding: 2px; vertical-align: middle;">
                            <?php echo listarId("categorias",$d["id_categoria"])["nome"]; ?>
                        </td>
                        <td style="padding: 2px; vertical-align: middle;">
                            <?php echo $d["nome"]; ?>
                        </td>
                        ...
                        <td style="text-align: center; padding: 2px; vertical-align: middle;">
                            ...
                            <?php if (excluir($tabela)) {
                                dlConfirma($pagina . "&acao=deletar&id=" . $d["id"], "Deletar pizza", "Tem certeza que quer deletar essa Pizza?", "glyphicon-trash");
                            } ?>
                        </td>
                    </tr>
                <?php } ?>
